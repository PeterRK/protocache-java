...
|:-------|----:|----:|----:|----:|----:|
| Data Size | 574B | 780B | 1296B | 584B | 566B |
| Compressed Size | 566B | 571B | 856B | 559B | 534B |
| Decode + Traverse | 2624ns | 819ns | 1280ns | 1962ns | 1289ns |
| Decmpress | 411ns | 626ns | 1323ns | 427ns | 412ns |

Without zero-copy technique, the Java version is slow. [Fory](https://fory.apache.org) claims better performace than Protobuf and FlatBuffers, and our benchmark shows that's truth.
