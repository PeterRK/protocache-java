...
import com.github.peterrk.protocache.*;

public class Main extends com.github.peterrk.protocache.Message {
    ...
    public Main(com.github.peterrk.protocache.DataView data) {
        super(data);
    }
    ...
    public int getU32() {
        return getInt32(FIELD_u32);
    }

    public long getI64() {
        return getInt64(FIELD_i64);
    }

    public long getU64() {
        return getInt64(FIELD_u64);
    }
    ...
    public byte[] getData() {
        return getBytes(FIELD_data);
    }

    public float getF32() {
        return getFloat32(FIELD_f32);
    }

    public double getF64() {
        return getFloat64(FIELD_f64);
    }
    ...
    public Int32Array getI32v() {
        return getInt32Array(FIELD_i32v);
    }

    public Int64Array getU64v() {
        return getInt64Array(FIELD_u64v);
    }

    public StrArray getStrv() {
        return getStrArray(FIELD_strv);
    }

    public com.github.peterrk.protocache.BytesArray getDatav() {
        return getBytesArray(FIELD_datav);
    }

    public Float32Array getF32v() {
        return getFloat32Array(FIELD_f32v);
    }

    public Float64Array getF64v() {
        return getFloat64Array(FIELD_f64v);
    }

    public BoolArray getFlags() {
        return getBoolArray(FIELD_flags);
    }
    ...
    public int getTU32() {
        return getInt32(FIELD_t_u32);
    }

    public int getTI32() {
        return getInt32(FIELD_t_i32);
    }

    public int getTS32() {
        return getInt32(FIELD_t_s32);
    }

    public long getTU64() {
        return getInt64(FIELD_t_u64);
    }

    public long getTI64() {
        return getInt64(FIELD_t_i64);
    }

    public long getTS64() {
        return getInt64(FIELD_t_s64);
    }

    public Dictionary<Str, Int32> getIndex() {
        return getField(FIELD_index, Dictionary<Str, Int32>::new);
    }

    public Dictionary<Int32, Small> getObjects() {
        return getField(FIELD_objects, Dictionary<Int32, Small>::new);
    }
